...
writeFileSync('dist/data/site.json', JSON.stringify({ name:'Odin R&D', version:'0.1.1', issued:'2026-09-07', builtAt:new Date().toISOString(), source:'https://github.com/odin-labs-ai/odin-rnd', revision:report.revision, experimentRun:report.workflowRun, drawing:'Conceptual software-factory assembly; not a map of deployed infrastructure.' }, null, 2)+'\n');
