...
<p>These criteria were committed at 13:27 UTC on 24 September 2026, before the recorded measurement (<code>measuredAt</code> 13:34 UTC). The experiment was built in parallel branches that were later combined, so in <code>git log</code> the results commit appears before the criteria commit; the commit author dates give the true order. Any one of them failing refutes the claim for this corpus.</p>
