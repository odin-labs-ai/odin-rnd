...
export const sources = [
  ...
  { id: 'awesome-jev-tools', label: 'v-modal, awesome-jev-tools (community list of Jev projects, GitHub)', url: 'https://github.com/v-modal/awesome-jev-tools', kind: 'community list', claim: 'Lists Laya under Calibration & Research as an open alternative to Jev, alongside other open replicas and independent Jev evaluations. A list entry is not an endorsement; the list says so itself.' },
...
<p>These criteria were committed at 13:27 UTC on 24 September 2026, before the recorded measurement (<code>measuredAt</code> 13:34 UTC). The experiment was built in parallel branches that were later combined, so the order of commits in the repository history does not show which came first; the commit author dates give the true order. Any one of them failing refutes the claim for this corpus.</p>
